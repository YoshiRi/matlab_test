...
figure(11)
plt=plot(t,Z,':',t,X_prop(2,:),t,X_conv1(2,:),'-.',t,X_conv3(2,:),'--')
setfigcolor(plt,'grobp')
...
figure(12)
plt=plot(t,VZ,':',t,X_prop(3,:),t,X_conv1(3,:),'-.',t,X_conv3(3,:),'--')
setfigcolor(plt,'grobp')
...
figure(21)
plt=plot(t,abs(X_prop(2,:)-Z'),t,abs(X_conv1(2,:)-Z'),'-.',t,abs(X_conv3(2,:)-Z'),'--')
setfigcolor(plt,'robp')
...
figure(22)
plt=plot(t,abs(X_prop(3,:)-VZ'),t,abs(X_conv1(3,:)-VZ'),'-.',t,abs(X_conv3(3,:)-VZ'),'--')
setfigcolor(plt,'robp')
